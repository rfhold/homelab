...
| Secret | Secrets-management specs, Pulumi config, adapter, Kubernetes Secret, consuming workload | Values remain secret-tainted and absent from source, logs, ConfigMaps, and non-secret outputs. |
