...
| `programs/grafana-*/**` | [`docs/observability/spec/grafana.md`](../../../../docs/observability/spec/grafana.md), [`docs/observability/spec/alerting.md`](../../../../docs/observability/spec/alerting.md) | Review native asset shape, stable UIDs, shared folder ownership, provider stack outputs, apply order, and deletion or replacement effects. Do not infer current Grafana state or mutate it. |
