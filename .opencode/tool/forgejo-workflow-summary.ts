...
export default tool({
  description: "Get a quick summary of workflow runs status for a Forgejo repository",
  args: {
  ...
  async execute(args) {
    ...
    const url = `${forgejoHost}/api/v1/repos/${args.owner}/${args.repo}/actions/tasks?page=1&limit=${limit}`
