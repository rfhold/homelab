...
export const DOCKER_IMAGES = {
   ...
   */
  FIRECRAWL: {
    image: "cr.holdenitdown.net/rfhold/firecrawl:v2.6.0",
  ...
  FIRECRAWL_NUQ_POSTGRES: {
    image: "cr.holdenitdown.net/rfhold/firecrawl-nuq-postgres:v2.6.0",
   ...
   */
  PLAYWRIGHT_SERVICE: {
    image: "cr.holdenitdown.net/rfhold/firecrawl-playwright:v2.6.0",
