    ...
    this.configMap = new k8s.core.v1.ConfigMap(`${name}-config`, {
      ...
      data: {
        "buildkitd.toml": [
          ...
          "",
          '[registry."docker.io"]',
          '  mirrors = ["cr.holdenitdown.net"]',
          "",
          '[registry."docker.io".mirror."cr.holdenitdown.net"]',
          '  rewrite = {"^/(.*)$" = "/docker-hub/$1"}',
          "",
          '[registry."ghcr.io"]',
          '  mirrors = ["cr.holdenitdown.net"]',
          "",
          '[registry."ghcr.io".mirror."cr.holdenitdown.net"]',
          '  rewrite = {"^/(.*)$" = "/ghcr/$1"}',
          "",
          '[registry."nvcr.io"]',
          '  mirrors = ["cr.holdenitdown.net"]',
          "",
          '[registry."nvcr.io".mirror."cr.holdenitdown.net"]',
          '  rewrite = {"^/(.*)$" = "/nvcr/$1"}',
        ].join("\n"),
      },
